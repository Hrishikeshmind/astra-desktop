 ...
 */ export class SevenZipParser {
   ...
   */ parse(callback) {
    ...
    parseInternal(callback) {
        ...
        try {
            var _ref;
            var _this_signature;
            const headerResult = parseEncodedHeader(this.toBuffer(headerBuf), (_ref = (_this_signature = this.signature) === null || _this_signature === void 0 ? void 0 : _this_signature.nextHeaderCRC) !== null && _ref !== void 0 ? _ref : 0);
   ...
   */ createEntry(file, size, folderIndex, streamInFolder) {
