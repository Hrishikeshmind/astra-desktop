...
import { SPARSE_ENTRIES_IN_HEADER, SPARSE_ENTRY_NUMBYTES_SIZE, SPARSE_ENTRY_OFFSET_SIZE, SPARSE_ENTRY_SIZE, SPARSE_EXTENDED_ENTRIES, SPARSE_EXTENDED_ISEXTENDED_OFFSET, SPARSE_ISEXTENDED_OFFSET, SPARSE_OFFSET, SPARSE_REALSIZE_OFFSET, SPARSE_REALSIZE_SIZE } from './constants.js';
import EntryStream from './EntryStream.js';
import { decodeOct } from './headers.js';
 ...
 */ export function parseGnuSparseHeader(headerBuf) {
 ...
 */ export function parseGnuSparseExtended(extBuf) {
 ...
 */ export function sparseDataSize(entries) {
    let total = 0;
