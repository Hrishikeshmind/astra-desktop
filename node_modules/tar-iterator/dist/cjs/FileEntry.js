...
var TarFileEntry = /*#__PURE__*/ function(FileEntry) {
    ...
    _proto.create = function create(dest, options, callback) {
        ...
        if (typeof callback === 'function') {
            _extractbaseiterator.FileEntry.prototype.create.call(this, dest, options, function(err) {
                callback(err);
                if (_this.lock) {
                    _this.lock.release();
                    _this.lock = null;
    ...
    _proto._writeFile = function _writeFile(fullPath, _options, callback) {
        ...
        var cb = (0, _calloncefn.default)(function(err) {
            err ? callback(err) : (0, _extractbaseiterator.waitForAccess)(fullPath, callback); // gunzip stream returns prematurely occasionally
        });
        try {
