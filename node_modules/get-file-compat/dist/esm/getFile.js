...
function run(endpoint, dest, options, callback) {
...
const worker = noHTTPS ? bind('>0', workerPath, {
    callbacks: true,
    spawnOptions: false
}) : run;
export default function getFile(endpoint, dest, optionsOrCallback, callback) {
